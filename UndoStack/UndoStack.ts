...
export class UndoStack {
    save_requirement = 'phrase'
    common_action1 = 'common_action'
    prevActionIndex = 0;
    actionIndex = 0;
    undoStack = [];
    ...
    createMarkerDrawEntry(prevPos, currentPos) {
        const posEntry = {}
        posEntry['entry'] = { type: this.common_action1, prevPos: prevPos, currentPos: currentPos, index: this.actionIndex };
